<template>
  <section id="waitlist" ref="sectionRef" class="relative py-28 lg:py-40 overflow-hidden">
    <!-- Red ambient glow — off-center -->
    <div class="absolute -top-40 right-0 w-[600px] h-[400px] bg-f1-red/[0.03] rounded-full blur-[200px] pointer-events-none" />
    ...
    <div class="max-w-[1400px] mx-auto px-6 lg:px-12">
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-end">
        ...
        <div ref="textRef" class="opacity-0 lg:col-span-7">
          <span class="font-heading text-[10px] tracking-[0.4em] uppercase text-f1-red/50 mb-6 block">Lista de espera</span>
          <h2 class="font-heading font-black text-4xl sm:text-5xl lg:text-6xl text-white leading-[0.9] tracking-tight">
            ¿Listo para<br>
            <span class="text-f1-red">la pole?</span>
          </h2>
          <p class="text-white/25 text-sm mt-6 max-w-sm leading-relaxed">
            Acceso anticipado + 1 mes de Premium gratis. Sin spam, solo lanzamiento.
          </p>
        </div>
        ...
        <div ref="formRef" class="opacity-0 lg:col-span-5">
          <form @submit.prevent="handleSubmit" class="space-y-3">
            ...
            >
              <span v-if="!submitted">Reservar mi lugar →</span>
              <span v-else>✓ Estás dentro</span>
            </button>
          </form>
          <p v-if="submitted" class="text-f1-red/50 text-xs mt-3">
